angular.module('app.services').service('HighlightService',
    ['$sce', function ($sce) {
    /**
 ...
 */
    ...
    var destacar = function (texto, filtro) {

        if (!filtro) {
            return $sce.trustAsHtml(texto);
        }

        var textoAlterado = texto.replace(make_pattern(removeDiacritics(filtro)), '<span class="highlightedText">$&</span>');
        return $sce.trustAsHtml(textoAlterado);
    }
