(function($) {
    ...
    $.fn.oDataFilterUI = function (options)
    {
        ...
        var noFilterMessage = $("<span>").html("Nenhum filtro aplicado").prependTo(container);
        ...
        var addAnother = $('<a>', { class: "addAnother", href: "#", "data-bind": "click: addAnother"  }).html("Adicionar").appendTo(container);
        ...
        var createRow = function () {
            ...
            var operatorsList = ko.computed(function() {
                ...
                switch (fieldType) {
                    ...
                    case "double":
                    case "single":
                        result.push({ text: "Maior que", value: "gt" });
                        result.push({ text: "Maior ou igual", value: "ge" });
                        result.push({ text: "Menor que", value: "lt" });
                        result.push({ text: "Menor ou igual a", value: "le" });
                        break;
                    case "string":
                        result.push({ text: "Contendo", value: "contains" });
                        result.push({ text: "Iniciando com", value: "startswith" });
                        result.push({ text: "Terminando com", value: "endswith" });
                        break;
                    default:
                        if (fieldType.indexOf("array[") >= 0)
                        {
                            ...
                            result = [];
                            result.push({ text: "Qualquer", value: "any" });
                            result.push({ text: "Todos", value: "all" });
                            result.push({ text: "Quantidade", value: "count" });                            
                            ...
                            switch (arrayType) {
                                ...
                                case "double":
                                case "single":
                                    result.push({ text: "Soma", value: "sum" });
                                    result.push({ text: "Média", value: "average" });
                                case "string":
                                    result.push({ text: "Mínimo", value: "min" });
                                    result.push({ text: "Máximo", value: "max" });
                                    break;
                            }
                        }
